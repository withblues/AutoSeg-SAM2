...
#SBATCH --output=logs_postprocess_slurm/ocr_vqa_array_%A_%a.out  # Separate log for each task
...
BASE_MASK_DIR="./output/ocr_vqa"
BASE_OUTPUT_DIR="./postprocess/ocr_vqa"
