...
#SBATCH --job-name=VG_100K
#SBATCH --output=logs_postprocess_slurm/VG_100K_array_%A_%a.out  # Separate log for each task
...
BASE_SUBSET_DIR="./videos/vg/VG_100K/subsets"
BASE_MASK_DIR="./output/vg/VG_100K"
BASE_OUTPUT_DIR="./postprocess/vg/VG_100K"
