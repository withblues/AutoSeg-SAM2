...
#SBATCH --output=logs_postprocess_slurm/textvqa_array_%A_%a.out  # Separate log for each task
...
BASE_SUBSET_DIR="./videos/textvqa/subsets"
BASE_MASK_DIR="./output/textvqa"
BASE_OUTPUT_DIR="./postprocess/textvqa"
