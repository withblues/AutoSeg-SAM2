...
#SBATCH --output=logs_postprocess_slurm/coco_array_%A_%a.out  # Separate log for each task
...
BASE_SUBSET_DIR="./videos/coco/subsets"
BASE_MASK_DIR="./output/coco/"
BASE_OUTPUT_DIR="./postprocess/coco"
